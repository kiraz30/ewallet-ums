...
type SendNotificationRequest struct {
	...
	Recipient     string                 `protobuf:"bytes,2,opt,name=recipient,proto3" json:"recipient,omitempty"`                                                                                 //Therecipient'scontact(email,phonenumber,ordeviceID)
	Placeholders  map[string]string      `protobuf:"bytes,3,rep,name=placeholders,proto3" json:"placeholders,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` //A map of placeholder store place in the templatebody(e.g.,{{username}}->"John")
...
type SendNotificationResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Message       string                 `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` //Amessageindicatingsuccessorfailure
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
